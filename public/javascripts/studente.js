...
const Studente = require('./models/studente'); // get our mongoose model
...
router.get('/me', async (req, res) => {
    ...
    let student = await Studente.findOne({email: req.loggedUser.email});
...
router.get('', async (req, res) => {
    ...
    if (req.query.email)
        // https://mongoosejs.com/docs/api.html#model_Model.find
        students = await Studente.find({email: req.query.email}).exec();
    else
        students = await Studente.find().exec();
